...
class SP_Cart {
	...
	public function __construct($params = array())
	{
		...
		$this->SP->load->driver('session', $config);

		// Grab the shopping cart array from the session table
		$this->_cart_contents = $this->SP->session->userdata('cart_contents');
	...
	protected function _save_cart()
	{
		...
		{
			$this->SP->session->unset_userdata('cart_contents');
		...
		$this->SP->session->set_userdata(array('cart_contents' => $this->_cart_contents));
