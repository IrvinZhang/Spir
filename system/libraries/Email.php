...
class SP_Email {
	...
	protected function _set_error_message($msg, $val = '')
	{
		...
		if (sscanf($msg, 'lang:%s', $line) !== 1 OR FALSE === ($line = $SP->lang->line($line)))
		{
