...
class SP_Upload {
	...
	public function do_upload($field = 'userfile')
	{
		...
		$this->file_name = $this->_SP->security->sanitize_filename($this->file_name);
	...
	public function do_xss_clean()
	{
		...
		// SP will itself look at the first 255 bytes of an image to determine its relative safety. This can save a lot of
		...
		return $this->_SP->security->xss_clean($data, TRUE);
	}
	...
	{
		$this->_SP->lang->load('upload');

		is_array($msg) OR $msg = array($msg);
		foreach ($msg as $val)
		{
			$msg = ($this->_SP->lang->line($val) === FALSE) ? $val : $this->_SP->lang->line($val);
			$this->error_msg[] = $msg;
	...
	protected function _file_mime_type($file)
	{
		 ...
		 * was reported in issue #750 (https://github.com/EllisLab/Spir/issues/750) - it's better
