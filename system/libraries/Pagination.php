...
class SP_Pagination {
	...
	public function __construct($params = array())
	{
		...
		$this->SP->load->language('pagination');
		foreach (array('first_link', 'next_link', 'prev_link', 'last_link') as $key)
		{
			if (($val = $this->SP->lang->line('pagination_'.$key)) !== FALSE)
			{
				$this->$key = $val;
			}
		}
	...
	public function initialize(array $params = array())
	{
		...
		if ($this->SP->config->item('enable_query_strings') === TRUE)
		{
		...
		{
			$this->suffix = $this->SP->config->item('url_suffix');
		}
	...
	public function create_links()
	{
		...
		if ($this->page_query_string === TRUE)
		{
			$this->cur_page = $this->SP->input->get($this->query_string_segment);
		}
		elseif (empty($this->cur_page))
		{
			...
			{
				$this->uri_segment = count($this->SP->uri->segment_array());
			}

			$this->cur_page = $this->SP->uri->segment($this->uri_segment);
