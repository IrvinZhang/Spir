...
class SP_Javascript {
	...
	public function __construct($params = array())
	{
		...
		$this->SP->load->library('Javascript/'.$js_library_driver, array('autoload' => $autoload));
		// make js to refer to current library
		$this->js =& $this->SP->$js_library_driver;
	...
	public function external($external_file = '', $relative = FALSE)
	{
		...
		elseif ($this->SP->config->item('javascript_location') !== '')
		{
			$this->_javascript_location = $this->SP->config->item('javascript_location');
		}
		...
		{
			$str = $this->_open_script($this->SP->config->slash_item('base_url').$this->_javascript_location.$external_file);
		}
	...
	{
		return '<script type="text/javascript" charset="'.strtolower($this->SP->config->item('charset')).'"'
			.($src === '' ? '>' : ' src="'.$src.'">');
	}
