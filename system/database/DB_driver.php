...
abstract class SP_DB_driver {
	 ...
	 * COUNT string
	 *
	 * @used-by	SP_DB_driver::count_all()
	 * @used-by	SP_DB_query_builder::count_all_results()
	 *
	 * @var	string
	 */
	...
	{
		$driver = 'SP_DB_'.$this->dbdriver.'_result';
	...
	{
		if ( ! class_exists('SP_DB_Cache', FALSE))
		{
		...
		$this->CACHE = new SP_DB_Cache($this); // pass db object to support multiple db connections and returned db objects
		return TRUE;
	}
